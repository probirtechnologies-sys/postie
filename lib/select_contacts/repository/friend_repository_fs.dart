// lib/friends/friend_repository_fs.dart
...
class FriendRepositoryFS {
  ...
  /// My friends list -> resolve to full UserModel cards
  ...
  Future<void> sendRequest({
    ...
    if (toUid == null) throw Exception('User not found for $toPhoneOrUid');
    if (toUid == fromUid) throw Exception('Cannot request yourself');
  ...
  Future<void> acceptRequest({
    ...
    final qs = await _friendRequests
        ...
        .limit(1)
        .get();
    if (qs.docs.isEmpty) throw Exception('No pending request');
